...
export async function GET() {
  try {
    ...
    logger.error("Failed to fetch deadline compliance", error instanceof Error ? error : undefined);
    return NextResponse.json({ error: "Failed to fetch deadline compliance" }, { status: 500 });
  }
}
