...
- [x] 4. Добавитьtsx-no-use-target-natively eslint rule для предотвращения утечек памяти в React
...
- [x] 10. Добавить type-safe API response types через Zod для всех JSON-ответов
