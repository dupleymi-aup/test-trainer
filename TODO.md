...
- [ ] 1. Добавить Prisma-индексы для полей в частых WHERE-запросах (userId, taskId, groupId, createdAt, action)
...
- [ ] 7. Добавить request logging middleware (method, path, status, duration) для всех API
